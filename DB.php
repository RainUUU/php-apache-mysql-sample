...
class DB
{
    ...
    {
        $serverName = env("MYSQL_PORT_3306_TCP_ADDR", "10.10.26.58");
        $databaseName = env("MYSQL_INSTANCE_NAME", "tHgIWMfp9NCJ6xi4");
        $username = env("MYSQL_USERNAME", "u1tMlIoiSNDshgRB");
        $password = env("MYSQL_PASSWORD", "p9crgd4s2mXiahzIb");
